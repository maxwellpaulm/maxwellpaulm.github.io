...
export class Terminal {
    ...
    ask(query) {
        ...
        try {
            ...
            const ret = wasm.terminal_ask(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ask_terminal_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
